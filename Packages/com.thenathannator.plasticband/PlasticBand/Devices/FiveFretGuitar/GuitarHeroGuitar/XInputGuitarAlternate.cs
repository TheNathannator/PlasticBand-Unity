...
namespace PlasticBand.Devices
{
    ...
    /// </summary>
    [InputControlLayout(stateType = typeof(XInputGuitarAlternateState), displayName = "XInput Guitar Hero Guitar")]
    public class XInputGuitarAlternate : GuitarHeroGuitar
    {
        ...
        private static readonly List<XInputGuitarAlternate> s_AllDevices = new List<XInputGuitarAlternate>();

        /// <summary>
        /// Registers <see cref="XInputGuitarAlternate"/> to the input system.
        /// </summary>
