...
{
    [InputControlLayout(stateType = typeof(XInputGuitarHeroGuitarLayout), displayName = "Santroller XInput Guitar Hero Guitar")]
    internal class SantrollerXInputGuitarHeroGuitar : TranslatingGuitarHeroGuitar_Discrete<XInputGuitarHeroGuitarState_GH5>, ISantrollerFiveFretGuitarHaptics
    {
