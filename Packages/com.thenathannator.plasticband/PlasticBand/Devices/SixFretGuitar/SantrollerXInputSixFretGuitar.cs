...
{
    [InputControlLayout(stateType = typeof(TranslatedSixFretState), displayName = "Santroller XInput Guitar Hero Live Guitar")]
    internal class SantrollerXInputSixFretGuitar : XInputSixFretGuitar, ISantrollerSixFretGuitarHaptics
    {
        internal new static void Initialize()
        {
            SantrollerLayoutFinder.RegisterXInputLayout<SantrollerXInputSixFretGuitar>(
                XInputController.DeviceSubType.GuitarAlternate, SantrollerDeviceType.LiveGuitar);
        }

        protected override void FinishSetup()
        {
            base.FinishSetup();
            m_Haptics = SantrollerSixFretGuitarHaptics.Create(this, StageKitProtocol.XInput);
        }
