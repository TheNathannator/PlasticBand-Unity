...
namespace PlasticBand.Devices.LowLevel
{
    ...
    internal unsafe struct PS3TurntableState : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "dpad/up", layout = "DiscreteButton", format = "BIT", bit = 0, sizeInBits = 4, parameters = "minValue=7,maxValue=1,nullValue=15,wrapAtValue=7", alias = "strumUp", displayName = "Up/Strum Up")]
