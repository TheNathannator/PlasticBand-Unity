...
{
    [InputControlLayout(stateType = typeof(TranslatedFiveLaneState), displayName = "Santroller XInput Guitar Hero Drumkit")]
    internal class SantrollerXInputFiveLaneDrumkit : XInputFiveLaneDrumkit, ISantrollerFiveLaneDrumkitHaptics
    {
        internal new static void Initialize()
        {
            SantrollerLayoutFinder.RegisterXInputLayout<SantrollerXInputFiveLaneDrumkit>(
                XInputController.DeviceSubType.DrumKit, SantrollerDeviceType.GuitarHeroDrums);
        }

        protected override void FinishSetup()
        {
            base.FinishSetup();
            m_Haptics = SantrollerFiveLaneDrumkitHaptics.Create(this, StageKitProtocol.XInput);
        }
