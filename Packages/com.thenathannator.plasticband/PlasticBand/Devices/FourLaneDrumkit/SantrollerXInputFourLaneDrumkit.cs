...
{
    [InputControlLayout(stateType = typeof(TranslatedFourLaneState), displayName = "Santroller XInput Rock Band Drumkit")]
    internal class SantrollerXInputFourLaneDrumkit : XInputFourLaneDrumkit, ISantrollerFourLaneDrumkitHaptics
    {
        ...
        {
            base.FinishSetup();
            m_Haptics = SantrollerFourLaneDrumkitHaptics.Create(this, StageKitProtocol.XInput);
        }
