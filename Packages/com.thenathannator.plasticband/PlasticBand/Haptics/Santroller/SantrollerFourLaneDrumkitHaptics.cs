...
{
    /// <summary>
    /// Bitmask of possible notes that can be hit on a 4-lane drumkit.
    /// </summary>
    [Flags]
    public enum FourLaneDrumkitHitNote : byte
    {
        None = 0,
        ...
        All = Kick | RedPad | YellowPad | BluePad | GreenPad | YellowCymbal | BlueCymbal | GreenCymbal,
    }
    ...
    public interface ISantrollerFourLaneDrumkitHaptics : ISantrollerHaptics
    {
        ...
        /// Use <see cref="FourLaneDrumkitHitNote.None"/> to disable all note hit LEDs.
        /// </param>
        void SetHitNotes(FourLaneDrumkitHitNote notes);
    }

    internal struct SantrollerFourLaneDrumkitHaptics : ISantrollerFourLaneDrumkitHaptics
    {
        ...
        private FourLaneDrumkitHitNote m_ActiveNotes;

        public static SantrollerFourLaneDrumkitHaptics Create(InputDevice device, StageKitProtocol protocol)
            => new SantrollerFourLaneDrumkitHaptics()
        {
            m_Base = SantrollerHaptics.Create(device, protocol),
            m_ActiveNotes = FourLaneDrumkitHitNote.None,
        };
        ...
        public void SetHitNotes(FourLaneDrumkitHitNote notes)
        {
            notes &= FourLaneDrumkitHitNote.All;
